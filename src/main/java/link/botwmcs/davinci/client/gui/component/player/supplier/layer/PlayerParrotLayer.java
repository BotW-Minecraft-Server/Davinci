...
public class PlayerParrotLayer extends PlayerEntityRenderLayer {
    private final ParrotModel model;
    public final PlayerModelProperties properties;

    public PlayerParrotLayer(RenderLayerParent renderer, EntityModelSet model, PlayerModelProperties properties) {
        super(renderer);
        this.model = new ParrotModel(model.bakeLayer(ModelLayers.PARROT));
